                            ...
                            <div class="pagination justify-content-end mb-0">
                                ...
                                if ($jumlahHalaman > 3) {
                                    ...
                                    if ($halaman > 3) {
                                        ...
                                        echo "<li class='page-item'><a class='page-link' href='form-tambah-dosen.php?halaman=$halSebelum'>...</a></li>";
                                    }
                                    ...
                                    if ($sisaHalaman > 0) {
                                        echo "<li class='page-item'><a class='page-link' href='form-tambah-dosen.php?halaman=$nextPaging'>...</a></li>";
                                    }
                                } else {
