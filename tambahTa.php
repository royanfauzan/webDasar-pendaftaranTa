...
if ($cek>0) {
    ...
    mysqli_query($koneksi,"insert into tugasAkhir(nimMhs, judulTa, tanggaldaftar, statusTa, pembimbing1, kodeProdiTa) values('$nim','$judul','$tanggal','$statusTa','$pembimbing1','$kodeProdi')");
    $expire = time()+5;
