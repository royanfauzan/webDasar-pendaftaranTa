...
<body>
    ...
    ?>
        ...
        <div class="main-content" id="panel">
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row justify-content-between">
                                <div class="col-4">
                                    <h3 class="mb-0">List Tugas Akhir</h3>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col">NIM</th>
                                        <th scope="col">File Terupload</th>
                                ...
                                <tbody>
                                    ...
                                    $data = mysqli_query($koneksi, "select * from tugasAkhir join mahasiswa on tugasAkhir.nimMhs = mahasiswa.nim WHERE statusTa=2");
                                    $jumlahData = mysqli_num_rows($data);
                                    $jumlahHalaman = ceil($jumlahData / $batas);

                                    $data = mysqli_query($koneksi, "select * from tugasAkhir left join mahasiswa on tugasAkhir.nimMhs = mahasiswa.nim WHERE statusTa=2 LIMIT $posisi,$batas");
                                    if ($jumlahData > 0) {
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    if (!empty($d['abstrak']) || !empty($d['fullPaper'])) {
                                                        if (!empty($d['abstrak']) && !empty($d['fullPaper'])) {
                                                            $warnaKolom = 2;
                                                            echo "<span class='$warnaKolom font-weight-700'> Lengkap </span>";
                                                        }elseif (!empty($d['abstrak'])) {
                                                            $warnaKolom = 1;
                                                            echo "<span class='$warnaKolom font-weight-700'> Abstrak Saja </span>";
                                                        }else {
                                                            $warnaKolom = 1;
                                                            echo "<span class='$warnaKolom font-weight-700'> Fullpaper Saja </span>";
                                                        }
                                                    }else {
                                                        $warnaKolom = 0;
                                                        echo "<span class='$warnaKolom font-weight-700'> Belum Upload </span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td>
                                                    <a href="#editDataTa<?php echo $no; ?>" data-toggle="modal" class="btn btn-sm btn-warning">Detail</a>
                                                    <a href="#hapusDataTa<?php echo $no; ?>" data-toggle="modal" class="btn btn-sm btn-outline-info">Lengkap</a>
                                                </td>
            ...
            <?php
            $no = 1;
            $data = mysqli_query($koneksi, "select judulTa, nimMhs, abstrak, fullpaper, tanggalDaftar, dospem1.namaDosen AS 'bimbing1',dospem2.namaDosen AS 'bimbing2' from tugasAkhir Left join dosen dospem1 on tugasAkhir.pembimbing1 = dospem1.nip Left join dosen dospem2 on tugasAkhir.pembimbing2 = dospem2.nip WHERE statusTa=2 LIMIT $posisi,$batas");
            while ($d = mysqli_fetch_array($data)) {
                $pembatal = "";
            ?>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="post" role="form" action="konfirmTaAdmin.php">
                                    <div class="pl-lg-4">
                                        <div class="row">
                                            <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <h4 class="text-muted font-weight-bold"> File Abstrak :
                                            ...
                                            <?php
                                                ...
                                                $pembatal = "disabled";
                                                echo "File Abstrak Belum diupload..";
                                            }
                                            ?>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="row justify-content-between align-items-end">
                                        ...
                                        <button name="persetujuan" type="submit" class="btn btn-info w-25 text-center" value="3" <?php echo $pembatal; ?>>Lengkap</button>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="modal fade" id="hapusDataTa<?php echo $no; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Apakah anda yakin <span class="text-danger">File-FILE</span> Tugas Akhir dengan Judul" <span class="text-info"><?php echo $d['judulTa']; ?></span> " Sudah Lengkap ?</p>
                                <form method="post" role="form" action="konfirmTaAdmin.php">
                                    <div class="col-lg-6 invisible">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-username">NIM</label>
